...
<div class="row">
    ...
    <div class="col-md-4">
        <p style="text-align: center"><h1>Bestätigung</h1></p>
    </div>
</div>
...
<div class="row">
    <div class="col-md-6 text-left">
        <div class="panel panel-info">
            <div class="panel-heading">Senden : </div>
            ...
            <div class="panel-footer text-right">
                <a href="account.php" role="button" class="btn btn-info">Veränderung</a>
            </div>
        </div>
    </div>
    <div class="col-md-6 text-left">
...
<form action="commandes.php" method="POST">
        <button type="submit" id="btnPrePayer" name="btnPrePayer"  class="btn btn-primary btn-lg">Bestätigen</a>
</form>
