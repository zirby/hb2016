        ...
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand page-scroll" href="index.php">
                    <i class="fa fa-play-circle"></i>  Countrytickets.eu - Reservierung
                </a>
            </div>
            ...
            <div class="collapse navbar-collapse navbar-right navbar-main-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li><a class="page-scroll" href="reservations.php">Meine Reservierungen</a></li>
                    <li><a class="page-scroll" href="logout.php">Ausloggen</a></li>
