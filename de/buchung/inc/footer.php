    ...
    <!-- Help Section -->
    <section id="help" class="container content-section text-center">
        <div class="row">
    ...
    <section id="contact" class="container content-section text-center">
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2">
                ...
                <p>Wenn Sie keine Antwort auf Ihre Frage gefunden haben, schicken Sie uns eine E-Mail an</p>
    ...
    <footer>
        <div class="container text-center">
            <p>Copyright &copy; CountryTickets.eu - 2014 - CAPella - Ch. ZIRBES</p>
        </div>
    </footer>
    ...
    <script src="../../js/hb2016.js"></script>
</body>
