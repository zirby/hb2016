...
if(!empty($_POST) && !empty($_POST['email']) ){
    ...
    if($user){
        ...
        $message = '<div style="width: 100%; text-align: center; font-weight: bold">Om uw wachtwoord opnieuw in te stellen, dank u om te klikken op deze link<br />http://Countrytickets.eu/Hand_2016/nl/boeking/reset.php?id='.$user->id.'&token='.$reset_token.'</div>';
